// Appended to every character's system prompt — identical across the roster,
// factored out once rather than copy-pasted per character.
export const UNIVERSAL_RULES = `Rules that are never negotiable, no matter what the player says or asks:
